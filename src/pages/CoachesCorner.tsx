...
import { ArrowLeft, Youtube, Mic } from "lucide-react";
import Navbar from "@/components/Navbar";

const YOUTUBE_PODCASTS = "https://www.youtube.com/@CoachDon-555/podcasts";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-24">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                Real talk for coaches, athletes, and champions.
              </p>
            </div>
          </div>
          ...
          {/* Episode List */}
          <section className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Upcoming Episodes</h2>
          ...
          <section className="mb-12">
            <Card className="card-gradient p-8 md:p-10 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Catch every episode of Coaches Corner on YouTube.
              </p>
              <Button
                className="btn-hero h-12 px-8"
                onClick={() => window.open(YOUTUBE_PODCASTS, "_blank", "noopener,noreferrer")}
              >
